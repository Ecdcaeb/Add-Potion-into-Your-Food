...
public final class PotionUtil {
    ...
    public static float getWorldTickRate(Level level){
        return level == null ? 20.0F : level.tickRateManager().tickrate();
    }
    public static void playMachineWorldSound(Level level){
        //.shu
    }
}
