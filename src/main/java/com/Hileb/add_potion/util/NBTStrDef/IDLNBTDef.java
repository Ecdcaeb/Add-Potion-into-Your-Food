...
public class IDLNBTDef {
	...
	public static final String NAME_OFF= "add_potion.shared.off";
	public static final String NAME_ON= "add_potion.shared.on";
	...
	//gua socket
	public static final String GUA_NO_FREE_SOCKET_DESC = "add_potion.gua_enhance_no_free.desc";
	public static final String GUA_FREE_SOCKET_DESC = "add_potion.gua_enhance_free.desc";
	public static final String GUA_TOTAL_SOCKET_DESC = "add_potion.gua_enhance_total.desc";
	public static final String GUA_N_A_DESC = "add_potion.gua_not_applicable.desc";
	...
	public static final String KILL_COUNT_DESC = "add_potion.kill_count.desc";
