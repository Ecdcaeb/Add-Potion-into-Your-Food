package com.Hileb.add_potion.potion.buff;
...
public class BaseSimplePotion extends Potion {
    protected static final ResourceLocation resource = new ResourceLocation("add_potion","textures/misc/potions.png");
...
//    }
    ...
    public BaseSimplePotion(boolean isBadEffectIn, int liquidColorIn, String name, int icon) {
        ...
        setPotionName("add_potion.potion." + name);
        iconIndex = icon;
    }
